...
public class BookmarkController {
    ...
    public void save(@AuthenticationPrincipal final Long memberId,
                     @RequestBody final BookmarkRequest bookmarkRequest) {
        bookmarkService.save(memberId, bookmarkRequest);
    }

    @GetMapping
    public BookmarkResponses find(@AuthenticationPrincipal final Long memberId,
                                  final BookmarkSelectRequest request) {
