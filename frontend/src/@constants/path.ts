...
export const SLACK_URL = {
    LOGIN: `https://slack.com/oauth/v2/authorize?user_scope=channels:read,channels:write&redirect_uri=${process.env.SLACK_LOGIN_REDIRECT_URL}&client_id=${process.env.SLACK_CLIENT_ID}`,
