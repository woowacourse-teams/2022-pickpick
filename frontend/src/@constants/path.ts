...
export const SLACK_URL = {
  LOGIN: `https://slack.com/oauth/v2/authorize?scope=channels:history,channels:read,chat:write,incoming-webhook,users.profile:read,users:read,channels:manage&user_scope=channels:read,channels:write&redirect_uri=${process.env.SLACK_LOGIN_REDIRECT_URL}&client_id=${process.env.SLACK_CLIENT_ID}`,
