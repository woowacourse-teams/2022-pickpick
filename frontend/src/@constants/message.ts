...
export const MESSAGE = {
  ...
  LOGIN_SUCCESS: "성공적으로 로그인 되었어요! ",
  WORKSPACE_SUCCESS: "성공적으로 워크스페이스가 등록되었어요!",
  INVALID_SEARCH_CHANNELS: "채널을 하나 이상 선택 후 검색 버튼을 눌러주세요.",
  INVALID_SEARCH_KEYWORD: "검색할 키워드를 입력하신 후 검색 버튼을 눌러주세요.",
  INVALID_REMINDER_TIME: "리마인더 시간은 현재 시간보다 미래로 설정주세요.",
  LOGIN_REQUIRED: "로그인이 필요한 서비스에요.",
  CHANNEL_SUBSCRIPTION_REQUIRED:
    "현재 구독 중인 채널이 없어요! 먼저 채널을 구독하세요!",
  GET_MESSAGE_ERROR: "죄송해요. 현재 메시지를 가져올 수 없어요.",
  CONFIRM_REMINDER_REMOVE: "해당하는 메시지 리마인더를 정말 삭제하시겠어요?",
  WORKSPACE_DUPLICATE: "이미 등록된 워크스페이스에요.",
} as const;

export const API_ERROR_MESSAGE = {
  [ERROR_CODE.MEMBER_NOT_FOUND]: MESSAGE.LOGIN_REQUIRED,
  [ERROR_CODE.INVALID_TOKEN]: MESSAGE.LOGIN_REQUIRED,
  ...
  [ERROR_CODE.SUBSCRIPTION_NOT_FOUND]: MESSAGE.CHANNEL_SUBSCRIPTION_REQUIRED,
  [ERROR_CODE.BOOKMARK_NOT_FOUND]: MESSAGE.GET_MESSAGE_ERROR,
  [ERROR_CODE.MESSAGE_NOT_FOUND]: MESSAGE.GET_MESSAGE_ERROR,
} as const;
